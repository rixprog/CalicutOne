...
export const Navbar: React.FC = () => {
	return (
		<div className="flex items-center gap-4 px-6 py-4 bg-primary-600 shrink-0 w-full shadow-md z-20">
			<h1 className="text-xl font-bold tracking-tight text-white mr-8">CalicutOne</h1>
			<h3 className="text-m tracking-tight text-white mr-8">Administrator Dashboard</h3>
